...
export default function SignUpPage() {
    ...
    return (
        <div className="min-h-screen flex">
            ...
            {/* Right Panel - Visual */}
            <div className="hidden lg:flex flex-1 bg-gradient-to-br from-primary-500 via-primary-600 to-accent-600 items-center justify-center p-12">
                <div className="max-w-lg text-white">
                    ...
                    <ul className="space-y-4">
                        {[
                            'Create custom portfolio allocations',
                            'Project returns with multiple scenarios',
