...
__export(index_exports, {
  ...
  DEFAULT_ASSET_CATEGORIES: () => DEFAULT_ASSET_CATEGORIES,
  DEFAULT_VOLATILITY: () => DEFAULT_VOLATILITY,
  RISK_QUESTIONS: () => RISK_QUESTIONS,
  assessRisk: () => assessRisk,
  calculateAllocatedAmounts: () => calculateAllocatedAmounts,
  calculateCAGR: () => calculateCAGR,
  calculateEffectiveAnnualRate: () => calculateEffectiveAnnualRate,
  calculateEmergencyFund: () => calculateEmergencyFund,
  calculateFIRENumber: () => calculateFIRENumber,
  calculateLumpsumFV: () => calculateLumpsumFV,
  calculateLumpsumFVReal: () => calculateLumpsumFVReal,
  calculateNominalRate: () => calculateNominalRate,
  calculatePortfolioVolatility: () => calculatePortfolioVolatility,
  calculateRealRate: () => calculateRealRate,
  calculateRiskScore: () => calculateRiskScore,
  calculateSIPFV: () => calculateSIPFV,
  calculateSIPFVReal: () => calculateSIPFVReal,
  calculateSIPForGoal: () => calculateSIPForGoal,
  calculateSIPTotalContributions: () => calculateSIPTotalContributions,
  calculateYearsToDouble: () => calculateYearsToDouble,
  calculateYearsToMultiplier: () => calculateYearsToMultiplier,
  estimateYearsToFIRE: () => estimateYearsToFIRE,
  getCompoundingPeriods: () => getCompoundingPeriods,
  getContributionsPerYear: () => getContributionsPerYear,
  getDefaultExpectedReturn: () => getDefaultExpectedReturn,
  getDefaultVolatility: () => getDefaultVolatility,
